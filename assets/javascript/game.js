...
var wordGuessGame = {
    ...
    // Object of all words that can be chosen, along with info such as their picture and a word clip.
    wordsToPick: {
      sandcastle: {
        picture: "genesis.jpg",
        word: "sandcastle",
    ...
    updateWins: function() {
      ...
      if (win) {
        ...
        // Update the word title and band on the page.
        document.querySelector("#music").innerHTML = this.wordsToPick[this.wordInPlay].word +
        " By " + this.wordInPlay;
